...
// Re-export core types for Rust users (when used as a crate)
// These are the same types that the NAPI bindings wrap, just re-exported with cleaner names
pub use chia::bls::{PublicKey, SecretKey, Signature};
pub use chia::protocol::{Bytes, Bytes32, Coin as ChiaCoin, CoinSpend as ChiaCoinSpend, SpendBundle as ChiaSpendBundle};
pub use chia::puzzles::Proof as ChiaProof;
pub use chia_wallet_sdk::{
    client::Peer as ChiaPeer,
    driver::{DataStore as ChiaDataStore, DataStoreInfo, DataStoreMetadata as ChiaDataStoreMetadata, DelegatedPuzzle as ChiaDelegatedPuzzle},
};
...
// When not using NAPI, export the pure Rust API
#[cfg(not(feature = "napi"))]
pub use api::*;

// All NAPI bindings below this point
#[cfg(feature = "napi")]
#[napi]
